if (document.getElementById("app")) {
    ...
    createApp ({
        ...
        methods: {
            ...
            filtro() {
                this.productos = this.productosAll.filter( producto=>(producto.nombre == this.nombre || this.nombre==="All") && (producto.precio == this.precio || this.precio==="All" ))                
            },
            orden() {
            ...
            cargarListasDesplegables() {
                ...
                for (producto of this.productosAll) {
                  if (producto.nombre !== '' && this.nombres.indexOf(producto.nombre) < 0) {
